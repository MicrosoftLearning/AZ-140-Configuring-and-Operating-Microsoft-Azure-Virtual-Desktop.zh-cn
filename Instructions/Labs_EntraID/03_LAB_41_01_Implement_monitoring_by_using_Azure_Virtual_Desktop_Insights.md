...
1. 在“**CheckAMAConfiguration**”页上的“**资源诊断设置**”选项卡的“**主机池 az140-21-hp1**”部分中，注意警告消息，该消息指示找不到所选主机池的现有诊断配置，然后选择“**配置主机池**”。
1. 在“**导出模板**”窗格中选择“**部署**”。
...
1. 在 **CheckAMAConfiguration** 页上的“**选择主机数据设置**”选项卡上，选择工具栏中的“**刷新**”图标（圆形箭头）。

    > **备注**：在继续操作之前，请确保新创建的 DCR 在“**创建 DCR**”部分的“**可用 DCR**”子部分中列出。 如果没有列出，请等待一分钟，然后再次刷新页面。

1. 在“**选择主机数据设置**”选项卡上的“**所选 DCR**”下拉列表中，选择以 **microsoft-avdi-** 前缀开头的条目。
1. 在“**选择主机数据设置**”选项卡上的“**DCR 关联**”部分中，选择“**部署关联**”。
1. 在“**导出模板**”窗格中选择“**部署**”。
...
1. 在 **CheckAMAConfiguration** 页上的“**选择主机数据设置**”选项卡上，选择工具栏中的“**刷新**”图标（圆形箭头）。
1. 在“**选择主机数据设置**”选项卡上的“**会话主机缺少 Azure Monitor 扩展**”部分，选择“**添加扩展**”。
1. 在“**导出模板**”窗格中选择“**部署**”。
